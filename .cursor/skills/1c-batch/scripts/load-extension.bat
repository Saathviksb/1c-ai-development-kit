...
if "%~2"=="" ( 
 echo Использование: load-extension.bat ^ ^ [skipdbupdate] 
 echo. 
 echo Примеры: 
...
"%ONEC_PATH%" DESIGNER !IB_PARAMS! !AUTH_PARAMS! /DisableStartupDialogs /LoadConfigFromFiles "%XML_DIR%" -Extension "%EXT_NAME%" -updateConfigDumpInfo !UPDATE_PARAMS! /Out ".1c-log.txt"
