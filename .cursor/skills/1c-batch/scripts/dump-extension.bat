...
if "%~2"=="" ( 
 echo Использование: dump-extension.bat ^ ^ [update] 
 echo. 
 echo Примеры: 
...
"%ONEC_PATH%" DESIGNER !IB_PARAMS! !AUTH_PARAMS! /DisableStartupDialogs /DumpConfigToFiles "%XML_DIR%" -Extension "%EXT_NAME%" !UPDATE_PARAMS! /Out ".1c-log.txt"
