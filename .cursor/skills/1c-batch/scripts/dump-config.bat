...
if "%~1"=="" ( 
 echo Использование: dump-config.bat ^ [update] 
 echo. 
 echo Примеры: 
...
"%ONEC_PATH%" DESIGNER !IB_PARAMS! !AUTH_PARAMS! /DisableStartupDialogs /DumpConfigToFiles "%XML_DIR%" %DUMP_PARAMS% /Out ".1c-log.txt"
