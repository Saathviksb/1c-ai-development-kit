---
name: bsp-patterns
description: "Паттерны работы с БСП/SSL подсистемами: пользователи, файлы, печатные формы, фоновые задания, версионирование, email. Используй когда нужен паттерн работы с типовыми подсистемами БСП."
allowed-tools:
  - Read
  - Grep
  - Glob
